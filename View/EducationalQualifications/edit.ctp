...
<?php echo $this->Form->create('EducationalQualification');?>
	<fieldset>
		<legend><?php echo __('Edit Educational Qualification'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EducationalQualification.idEducationalQualifications')), null, __('Are you sure you want to delete # %s?', $this->Form->value('EducationalQualification.idEducationalQualifications'))); ?></li>
